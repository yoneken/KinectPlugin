...
static IFTFaceTracker *pFaceTracker;
static IFTResult *pFTResult;
static IFTImage *iftColorImage;
static IFTImage *iftDepthImage;
static bool lastTrackSucceeded;
static float faceScale;
static float faceR[3];
static float faceT[3];
...
void storeFace(int playerID, Vector4 (*skels)[NUI_SKELETON_POSITION_COUNT])
{
	HRESULT hrFT = E_FAIL;
